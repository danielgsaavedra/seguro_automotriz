...
class Direccion(models.Model):
    id_direccion = models.IntegerField(primary_key=True, verbose_name = 'ID Dirección')
...
class EstadoPresupuesto(models.Model):
    id_est_presupuesto = models.IntegerField(primary_key=True, verbose_name = 'ID Est. Presupuesto')
    nombre = models.CharField(max_length=30, verbose_name = 'Nombre')
...
class EstadoSiniestro(models.Model):
    id_est_siniestro = models.IntegerField(primary_key=True, verbose_name = 'ID Est. Siniestro')
    nombre = models.CharField(max_length=30, verbose_name = 'Nombre')
...
class InformeDano(models.Model):
    id_info_dano = models.IntegerField(primary_key=True, verbose_name = 'ID Inf. Daño')
    fecha_hora = models.DateField(verbose_name = 'Fecha')
...
class Marca(models.Model):
    id_marca = models.BigIntegerField(primary_key=True, verbose_name = 'ID Marca')
...
class PlanSeguro(models.Model):
    id_plan_seguro = models.IntegerField(primary_key=True, verbose_name = 'ID Plan')
...
class Presupuesto(models.Model):
    id_presupuesto = models.IntegerField(primary_key=True, verbose_name = 'ID Presupuestos')
    fecha_hora = models.DateField(verbose_name = 'Fecha')
...
class Region(models.Model):
    nro_region = models.IntegerField(primary_key=True, verbose_name = 'N° Región')
...
class SeveridadDano(models.Model):
    id_seve_dano = models.IntegerField(primary_key=True, verbose_name = 'ID Sev. Daños')
...
class Siniestro(models.Model):
    nro_siniestro = models.CharField(primary_key=True, max_length=10, verbose_name = 'N° Siniestro')
    fecha_hr = models.DateField(verbose_name = 'Fecha Siniestro')
    descripcion = models.CharField(max_length=100, verbose_name = 'Descripción')
    parte_policial = models.CharField(max_length=100, blank=True, null=True, verbose_name = 'Parte Policial')
    foto_licencia = models.CharField(max_length=100, blank=True, null=True, verbose_name = 'Foto Licencia')
...
class TipoAccidente(models.Model):
    id_tipo_acc = models.IntegerField(primary_key=True, verbose_name = 'ID Tipo Accidente')
    nombre = models.CharField(max_length=50, verbose_name = 'Nombre')
...
class TipoActa(models.Model):
    id_tipo_acta = models.FloatField(primary_key=True, verbose_name = 'ID Tipo Acta')
...
class TipoDano(models.Model):
    id_tipo_dano = models.IntegerField(primary_key=True, verbose_name = 'ID Tipo Daño')
    nombre = models.CharField(max_length=50, verbose_name = 'Nombre')
...
class TipoPlan(models.Model):
    id_tip_plan = models.IntegerField(primary_key=True, verbose_name = 'ID Tipo Plan')
...
class TipoVehiculo(models.Model):
    id_tipo_auto = models.IntegerField(primary_key=True, verbose_name = 'ID Tipo Auto')
...
class Usuario(models.Model):
    rut_usuario = models.CharField(primary_key=True, max_length=12, verbose_name = 'Rut Usuario')
    primer_nombre = models.CharField(max_length=20, verbose_name = 'Primer Nombre')
    segundo_nombre = models.CharField(max_length=20, verbose_name = 'Segundo Nombre')
    primer_apellido = models.CharField(max_length=20, verbose_name = 'Apellido Paterno')
