...
function validaTelefono() {
    ...
    if (!elemento.checkValidity()) {
        if (elemento.validity.valueMissing) {
            error_telefono(elemento, "Debe introducir su telefono");
        }
        if (elemento.validity.patternMismatch) {
...
function validaCorreo() {
    ...
    if (!elemento.checkValidity()) {
        if (elemento.validity.valueMissing) {
            error_correo(elemento, "Debe introducir su correo");
        }
        if (elemento.validity.patternMismatch) {
...
function validar(e) {
    ...
    || validaPrimerApellido() || validaSegundoApellido() || validaCorreo()) {
        return true 
    } else {
        e.preventDefault();
        return false;
